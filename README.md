...
Place train.csv, test.csv, and sample_submission.csv in the same folder as the notebook.
Install the required packages: pandas, numpy, matplotlib, seaborn, scikit-learn, catboost, lightgbm, and xgboost.
Run source_notebook.ipynb from top to bottom.
The notebook generates submission CSV files for Kaggle.
Final Result
